...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('flatpages_plus_flatpage', 'external_url',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FlatPage.gonews'
        db.add_column('flatpages_plus_flatpage', 'gonews',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('flatpages_plus_flatpage', 'external_url')

        # Deleting field 'FlatPage.gonews'
        db.delete_column('flatpages_plus_flatpage', 'gonews')
    ...
    models = {
        ...
        'flatpages_plus.flatpage': {
            'Meta': {'ordering': "('-date_publish',)", 'object_name': 'FlatPage'},
            ...
            'external_url': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'gonews': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
