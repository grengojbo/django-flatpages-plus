...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FlatPage.photo2'
        db.add_column('flatpages_plus_flatpage', 'photo2',
                      self.gf('sorl.thumbnail.fields.ImageField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FlatPage.date_publish'
        db.add_column('flatpages_plus_flatpage', 'date_publish',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FlatPage.date_unpublish'
        db.add_column('flatpages_plus_flatpage', 'date_unpublish',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FlatPage.meta_description'
        db.add_column('flatpages_plus_flatpage', 'meta_description',
                      self.gf('django.db.models.fields.CharField')(max_length=165, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FlatPage.meta_keywords'
        db.add_column('flatpages_plus_flatpage', 'meta_keywords',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FlatPage.photo2'
        db.delete_column('flatpages_plus_flatpage', 'photo2')

        # Deleting field 'FlatPage.date_publish'
        db.delete_column('flatpages_plus_flatpage', 'date_publish')

        # Deleting field 'FlatPage.date_unpublish'
        db.delete_column('flatpages_plus_flatpage', 'date_unpublish')

        # Deleting field 'FlatPage.meta_description'
        db.delete_column('flatpages_plus_flatpage', 'meta_description')

        # Deleting field 'FlatPage.meta_keywords'
        db.delete_column('flatpages_plus_flatpage', 'meta_keywords')
    ...
    models = {
        ...
        'flatpages_plus.flatpage': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'FlatPage'},
            ...
            'photo2': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
