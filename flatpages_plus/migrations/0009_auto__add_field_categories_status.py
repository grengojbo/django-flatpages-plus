...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Categories.status'
        db.add_column('flatpages_plus_categories', 'status',
                      self.gf('django.db.models.fields.CharField')(default='p', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Categories.status'
        db.delete_column('flatpages_plus_categories', 'status')
