...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FlatPage.enable_social'
        db.add_column('flatpages_plus_flatpage', 'enable_social',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FlatPage.enable_social'
        db.delete_column('flatpages_plus_flatpage', 'enable_social')
