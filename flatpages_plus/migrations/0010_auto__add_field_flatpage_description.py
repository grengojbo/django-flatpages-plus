...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FlatPage.description'
        db.add_column('flatpages_plus_flatpage', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FlatPage.description'
        db.delete_column('flatpages_plus_flatpage', 'description')
