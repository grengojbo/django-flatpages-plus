...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FlatPage.description'
        db.alter_column('flatpages_plus_flatpage', 'description', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'FlatPage.description'
        db.alter_column('flatpages_plus_flatpage', 'description', self.gf('django.db.models.fields.TextField')(null=True))
