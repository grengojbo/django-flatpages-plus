...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('flatpages_plus_categories', (
        ...
        db.send_create_signal('flatpages_plus', ['Categories'])

        # Adding field 'FlatPage.category'
        db.add_column('flatpages_plus_flatpage', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['flatpages_plus.Categories'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'FlatPage.name'
        db.alter_column('flatpages_plus_flatpage', 'name', self.gf('django.db.models.fields.CharField')(max_length=80))

        # Changing field 'FlatPage.url'
        db.alter_column('flatpages_plus_flatpage', 'url', self.gf('django.db.models.fields.CharField')(max_length=150))

    def backwards(self, orm):
        # Deleting model 'Categories'
        db.delete_table('flatpages_plus_categories')

        # Deleting field 'FlatPage.category'
        db.delete_column('flatpages_plus_flatpage', 'category_id')


        # Changing field 'FlatPage.name'
        db.alter_column('flatpages_plus_flatpage', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'FlatPage.url'
        db.alter_column('flatpages_plus_flatpage', 'url', self.gf('django.db.models.fields.CharField')(max_length=100))
