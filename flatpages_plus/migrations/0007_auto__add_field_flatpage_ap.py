...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FlatPage.ap'
        # db.add_column('flatpages_plus_flatpage', 'ap',
        #               self.gf('django.db.models.fields.related.ForeignKey')(to=orm['op.AreaPartners'], null=True, blank=True),
        #               keep_default=False)
        pass


    def backwards(self, orm):
        # Deleting field 'FlatPage.ap'
        # db.delete_column('flatpages_plus_flatpage', 'ap_id')
        pass
